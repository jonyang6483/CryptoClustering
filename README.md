...
The total explained variance is 0.895031657030984.
...
* Plot a line chart with all the inertia values computed with the different values of k to visually identify the optimal value for k.
* Answer the following question in your notebook:
* What is the best value for k when using the PCA data? - The best value for K is 4 again.
* Does it differ from the best k value found using the original data? - The results did not change fron the original data.
